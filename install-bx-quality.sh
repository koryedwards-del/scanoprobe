...
<html>
<head>
    <title>/tmp/files - install-bx-quality.sh</title>
...
<div id="container">
    ...
    <div class="show-content">
        <h2 class="file-title">install-bx-quality.sh</h2>

                    
            <p><a class="download" href="https://tmpfiles.org/dl/1788924521.82782afd1c755e14/w2wh4FrVFpKs/install-bx-quality.sh">Download (17.88 KB)</a></p>
        
        <p class="file-meta">File expires in 59 minutes</p>
    </div>
